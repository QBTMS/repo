 ...
 */
@Entity
@Table(name = "completedProjectTasks")
public class CompletedProjectTask {
    @Id
    ...
    public CompletedProjectTask() {
    }

    public CompletedProjectTask(Long project_id, int asignee, String projectTaskName, String projectTaskDiscription, Date startedDate, Date toBeCompleted, Date completedDate, int completenessLevel, int priority) {

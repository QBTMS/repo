...
public class CompletedUserTask {
    ...
    public CompletedUserTask(){}

    public CompletedUserTask(Date completedDate, String userName, String userTaskName, String userTaskDiscription, Date startedDate, Date toBeCompleted, int completenessLevel) {
